...
def main():
    ...
    guide=0
    time_updated = 0
    #probably I'll use more than 1 kind of interval
    interval = 40
    text_to_be_shown = ""
    player_act_counter = 0
    ### def hall
    def clean_text_no_timewait(text,clear_x,clear_y,counter,guide,time_now,time_updated,text_to_be_shown):
        if counter == len(text):
            guide+=1
            text_to_be_shown = ""
            counter = 0
            time_now = pygame.time.get_ticks()
            time_updated = pygame.time.get_ticks()
        return counter,guide,time_now,time_updated,text_to_be_shown
    ...
    #
    battle_trigger = 1 #maybe I'll start with 0 and after the difficulty selection change it to 1
    ##
    #ACT options
    ...
    #SWAP ITEMS IN THE GAME (if len(inventory) == 6 and hard_difficulty:
    #                   inventory[1] = "Great Potion" and inventory [4] = "OK Potion"
    ...
    #Anim 0
    enemy_awakes = [pygame.image.load("Assets/P_Idle/P_Idle_blue_yellow_0.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_blue_yellow_1.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_blue_yellow_2.png")]
    ...
    #Enemy Anim 1
    enemy_idle = [pygame.image.load("Assets/P_Idle/P_Idle_blue_yellow_2.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_blue_yellow_2.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_blue_yellow_2.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_blue_yellow_2.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_blue_yellow_2.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_blue1_yellow2.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_blue0_yellow1.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_blue0_yellow1.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_blue1_yellow0.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_blue1_yellow0.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_blue2_yellow1.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_blue2_yellow1.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_blue_yellow_2.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_blue_yellow_2.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_blue_yellow_2.png"),
    ...
    hard_enemy_idle = [pygame.image.load("Assets/P_Idle/P_Idle_yellow_blue_2.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_yellow_blue_2.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_yellow_blue_2.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_yellow_blue_2.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_yellow_blue_2.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_yellow1_blue2.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_yellow0_blue1.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_yellow0_blue1.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_yellow1_blue0.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_yellow1_blue0.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_yellow2_blue1.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_yellow2_blue1.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_yellow_blue_2.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_yellow_blue_2.png"),
                    pygame.image.load("Assets/P_Idle/P_Idle_yellow_blue_2.png"),
    ...
    #Enemy Anim 2
    enemy_get_hit_animation = pygame.image.load("Assets/P_Idle/P_Idle_blue_yellow_0.png")
    hard_enemy_get_hit_animation = pygame.image.load("Assets/P_Idle/P_Idle_yellow_blue_0.png")
    ...
    #Player Anim 0
    player_stand = pygame.image.load("Assets/C_Stand/C-Stand.png")
    player_stand = pygame.transform.scale(player_stand, (size_player_x,size_player_y))
    #change x, y to RESIZE the picture
    # Anim 1
    player_start = [pygame.image.load("Assets/C_start/C-Start1.png"),pygame.image.load("Assets/C_start/C-Start2.png"),
                    pygame.image.load("Assets/C_start/C-Start3.png"),pygame.image.load("Assets/C_start/C-Start4.png"),
                    pygame.image.load("Assets/C_start/C-Start5.png"),pygame.image.load("Assets/C_start/C-Start6.png"),
                    pygame.image.load("Assets/C_start/C-Start7.png"),pygame.image.load("Assets/C_start/C-Start8.png"),
                    pygame.image.load("Assets/C_start/C-Start9.png"),pygame.image.load("Assets/C_start/C-Start10.png"),
                    pygame.image.load("Assets/C_start/C-Start11.png")]
    ...
    #Player Anim 2
    player_idle = [pygame.image.load("Assets/C_Idle/C-Idle1.png"),
                             pygame.image.load("Assets/C_Idle/C-Idle2.png"),
                             pygame.image.load("Assets/C_Idle/C-Idle3.png"),
                             pygame.image.load("Assets/C_Idle/C-Idle4.png"),
                             pygame.image.load("Assets/C_Idle/C-Idle5.png"),
                             pygame.image.load("Assets/C_Idle/C-Idle6.png")]
    ...
    #Player Anim 3
    player_think = [pygame.image.load("Assets/C_Think/C-Think1.png"),
                    pygame.image.load("Assets/C_Think/C-Think2.png")]
    ...
    #Player Anim 4
    player_fumble = [pygame.image.load("Assets/C_Item/C-Item1.png"),
                     pygame.image.load("Assets/C_Item/C-Item2.png")]
    ...
    # Anim 5 - 5.5
    player_prepare_attack = pygame.image.load("Assets/C_Attack/C-Atk1.png")
    ...
    player_attack = [pygame.image.load("Assets/C_Attack/C-Atk2.png"),
                     pygame.image.load("Assets/C_Attack/C-Atk3.png"),
                     pygame.image.load("Assets/C_Attack/C-Atk4.png"),
                     pygame.image.load("Assets/C_Attack/C-Atk5.png"),
                     pygame.image.load("Assets/C_Attack/C-Atk6.png"),
                     pygame.image.load("Assets/C_Attack/C-Atk7.png"),
                     pygame.image.load("Assets/C_Attack/C-Atk8.png")]
    ...
    #Player Anim 6
    player_act = [pygame.image.load("Assets/C_Act/C-Act1.png"),pygame.image.load("Assets/C_Act/C-Act2.png"),
                  pygame.image.load("Assets/C_Act/C-Act3.png"),pygame.image.load("Assets/C_Act/C-Act4.png"),
                  pygame.image.load("Assets/C_Act/C-Act5.png"),pygame.image.load("Assets/C_Act/C-Act6.png"),
                  pygame.image.load("Assets/C_Act/C-Act7.png"),pygame.image.load("Assets/C_Act/C-Act8.png"),
                  pygame.image.load("Assets/C_Act/C-Act9.png"),pygame.image.load("Assets/C_Act/C-Act10.png"),
                  pygame.image.load("Assets/C_Act/C-Act11.png")]
    ...
    #Player Anim 7 - 7.5
    player_get_hit_animation = pygame.image.load("Assets/C_TakeDamage/C-GetHit.png")
    player_get_hit_animation = pygame.transform.scale(player_get_hit_animation,(size_player_x,size_player_y))
    player_fainted = pygame.image.load("Assets/C_TakeDamage/C-Down.png")
    player_fainted = pygame.transform.scale(player_fainted, (size_player_x,size_player_y))

    #Player Anim 8
    player_item = [pygame.image.load("Assets/C_Item/C-Item3.png"),
                   pygame.image.load("Assets/C_Item/C-Item4.png"),
                   pygame.image.load("Assets/C_Item/C-Item5.png"),
                   pygame.image.load("Assets/C_Item/C-Item6.png"),
                   pygame.image.load("Assets/C_Item/C-Item7.png"),
                   pygame.image.load("Assets/C_Item/C-Item8.png")]
    ...
    #pygame.mixer.music.load("Assets/Sound_effs/Rude Buster.mp3")

    music = {
        "rude buster": "Assets/Sound_effs/Rude Buster.mp3",
        "hammer of justice": "Assets/Sound_effs/Hammer of Justice.mp3",
        "wise farewell": "Assets/Sound_effs/Wise words.mp3"
    }
    ...
    sefx = {"select_enter": pygame.mixer.Sound("Assets/Sound_effs/snd_select.wav"),
            "select_arrow": pygame.mixer.Sound("Assets/Sound_effs/snd_menumove.wav"),
            "attack": pygame.mixer.Sound("Assets/Sound_effs/snd_damage.wav"),
            "hurt":pygame.mixer.Sound("Assets/Sound_effs/snd_hurt1.wav"),
            "start battle": pygame.mixer.Sound("Assets/Sound_effs/snd_weaponpull.wav"),
            "heal":pygame.mixer.Sound("Assets/Sound_effs/snd_power.wav"),
            "hit": pygame.mixer.Sound("Assets/Sound_effs/snd_damage.wav"),
            "right answer": pygame.mixer.Sound("Assets/Sound_effs/snd_coin.wav"),
            "wrong answer": pygame.mixer.Sound("Assets/Sound_effs/snd_error.wav"),
            "magic": pygame.mixer.Sound("Assets/Sound_effs/snd_boost.wav"),
            "critical hit1": pygame.mixer.Sound("Assets/Sound_effs/snd_knight_cut.wav"),
            "critical hit2": pygame.mixer.Sound("Assets/Sound_effs/snd_rudebuster_hit.wav")}
                ...
                if main_bar==True:
                    ...
                    if event.key == pygame.K_RETURN:
                        ...
                        if magic_option == 0:
                            ...
                            elif player_damage_chances[0] <= 4 and not act_option2_pressed:
                                player_damage_chances = [4, 16, 25, 25, 30]
                                max_acc_reached = True
                                box_to_cover_visibility = True
                                time_now = pygame.time.get_ticks()
                                time_game = time_now

                            elif player_damage_chances[0]<= 1 and act_option2_pressed:
                                limit_break = True
                                player_damage_chances = [4, 16, 25, 25, 30]
                                max_acc_reached = True
                                box_to_cover_visibility = True
                        ...
                        if terminal_phase:
                            if terminal_action == 1:
                                ...
                                if attack_chosen == 'numbers':
                                    ...
                                    try:
                                        ...
                                        after_answer = time()
                                        if math.trunc(after_answer - before_answer) >= late_answer_time:
                                            late_answer = True
                                ...
                                ####################################################################################
                                    ...
                                    try:
                                        ...
                                        if hard_battle_playing:
                                            if math.trunc(after_answer - before_answer) >= late_answer_time+3:
                                                late_answer = True
                                ...
                                ####################################################################################
                                    ...
                                    if hard_battle_playing:
                                        ...
                                        if math.trunc(after_answer - before_answer) >= late_answer_time+4:
                                            late_answer = True
                            ...
                            ## If it uses magic, how will the CPU use? ##
                                ...
                                if hard_battle_playing and debuff_atk and debuff_def:
                                    enemy_magic = 2
                                elif hard_battle_playing and debuff_atk and not debuff_def:
                                    enemy_magic = 2
                                elif hard_battle_playing and debuff_def and not debuff_atk:
                                    enemy_magic = 1
